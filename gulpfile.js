...
task('build',
 series(
   'clean',
   parallel('copy:html',"copy:img", "copy:svg", "copy:fonts", 'styles', 'scripts'),'server')
);

task("default", series("clean", parallel("copy:html", "copy:img", "copy:svg", "copy:fonts", "styles", "scripts"), parallel('watch',"server")));
